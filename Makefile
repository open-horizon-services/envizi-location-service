...
MATCH ?= "OhEnviziLocationService"
TIME_OUT ?= 30

# The Open Horizon Exchange's organization ID namespace where you will be publishing files
HZN_ORG_ID ?= examples

export SERVICE_NAME ?= oh-envizi-location-service
PATTERN_NAME ?= pattern-oh-envizi-location-service
DEPLOYMENT_POLICY_NAME ?= deployment-policy-oh-envizi-location-service
NODE_POLICY_NAME ?= node-policy-oh-envizi-location-service
